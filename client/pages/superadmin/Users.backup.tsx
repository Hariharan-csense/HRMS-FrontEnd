                        ...
                        <TableCell className="py-3 px-4 sm:py-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-sm text-muted-foreground truncate">ID: {user.id}</div>
                            </div>
                          </div>
                        </TableCell>
                        <TableCell className="hidden sm:table-cell py-2 px-4">{user.email}</TableCell>
                        <TableCell className="py-2 px-4">{user.organization}</TableCell>
                    ...
                    <TableRow>
                      <TableCell colSpan={7} className="h-24 text-center">
                        No users found.
                            ...
                            <div className="sm:hidden mt-3 space-y-2 text-sm">
                              <div className="flex items-center text-muted-foreground">
                                <Mail className="h-4 w-4 mr-2 flex-shrink-0" />
                                <span className="truncate">{user.email}</span>
                              </div>
                          </TableCell>
                          <TableCell className="hidden sm:table-cell py-2 px-4">{user.organization}</TableCell>
                          <TableCell className="py-2 px-4">
                            <div className="flex items-center justify-between sm:block">
                              <span className="sm:hidden text-sm font-medium text-muted-foreground">Role:</span>
                              <Select
